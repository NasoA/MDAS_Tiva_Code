...
uint8_t pui8BufferOut[8];
	pui8BufferOut[0] = (brake&0x000000FF);
	pui8BufferOut[1] = (brake&0x0000FF00)>>8;
	pui8BufferOut[2] = (brake&0x00FF0000)>>16;
	pui8BufferOut[3] = (brake&0xFF000000)>>24;
	
	pui8BufferOut[4] = (throttle&0x000000FF);
	pui8BufferOut[5] = (throttle&0x0000FF00)>>8;
	pui8BufferOut[6] = (throttle&0x00FF0000)>>16;
	pui8BufferOut[7] = (throttle&0xFF000000)>>24;
		
	//Configure transmit of message object.
	sMsgObjectTx.ui32MsgID =  px2_address;
